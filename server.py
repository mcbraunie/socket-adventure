...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You enter the room with a red dragon.",
            "You've entered a room crawling with snakes!",
            "You've entered a room with a sleeping giant.",
            "You are in a room with unicorns and rainbows.",
        ][room_number]
    ...
    def route(self):
        ...
        # var 'command' should now be "say" and var 'arguments' should
        # be "Is anybody here?"

        # If self.input_buffer was 'move north' then:
        # var 'command' should be "move" and var 'arguments' should be 'north'
